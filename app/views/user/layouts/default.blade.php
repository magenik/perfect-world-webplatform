...
<body class="skin-josh">
    <header class="header">
        <a href="{{ URL::to('user/index') }}" class="logo">
                ...
                <div class="page-sidebar  sidebar-nav">
                    <div class="nav_icons">
                        <ul class="sidebar_threeicons">
                            <li>
                                <a href="https://www.swordsmaneu.com" target="_blank">
                                    <i class="livicon" data-name="hammer" title="Website" data-loop="true" data-color="#42aaca" data-hc="#42aaca" data-s="25"></i>
                                </a>
                            </li>
                            <li>
                                <a href="http://forum.swordsmaneu.com" target="_blank">
                                    <i class="livicon" data-name="list-ul" title="Forum" data-loop="true" data-color="#e9573f" data-hc="#e9573f" data-s="25"></i>
                                </a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <ul id="menu" class="page-sidebar-menu">
                        ...
                        <li {{ (Request::is('user/users') || Request::is('user/users/*') ? 'class="active"' : '') }}>
                            <a href="#">
    ...
    @if (Request::is('user/form_builder2') || Request::is('user/gridmanager') || Request::is('user/portlet_draggable'))
